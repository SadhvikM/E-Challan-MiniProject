...
<body>
    <div id="wrapper">
        ...
        <h3 style="text-align:center;"><a href="index.php" style="text-decoration: none !important;color: white;">Online Fees Payment System</a></h3>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="fees.php"><i class="fa fa-usd "></i>Fee Due</a>
                    </li>
					 <li>
