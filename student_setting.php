...
$sql = "select * from student_users where username= '".$_SESSION['rainbow_username']."' and password='".$oldpassword."'";
$q = $conn->query($sql);
if($q->num_rows>0)
{
	$sql = "update student_users set  password = '".$newpassword."' WHERE username = '".$_SESSION['rainbow_username']."'";
	$r = $conn->query($sql);
	echo '<script type="text/javascript">window.location="student_setting.php?act=1"; </script>';
...
?>
               ...
               <div class="panel panel-primary">
						...
						<form action="student_setting.php" method="post" id="signupForm1" class="form-horizontal">
						...
						<div class="form-group">
								<div class="col-sm-9 col-sm-offset-4">
									<button type="submit" name="student_save" class="btn btn-primary">Save </button>
								</div>
							</div>
